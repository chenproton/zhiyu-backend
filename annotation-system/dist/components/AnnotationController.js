...
function AnnotationController({ mode, setMode, user, setUser, annotationCount, zIndex = 500, theme, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: `fixed bg-white rounded-xl shadow-lg border border-gray-200 p-3 select-none transition-shadow ${isDragging ? 'shadow-2xl cursor-grabbing' : 'cursor-grab'}`, style: {
            ...
            color: theme?.panelText ?? '#374151',
        }, onMouseDown: handleMouseDown, children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-2 mb-3", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.GripVertical, { className: "w-4 h-4 text-gray-400" }), (0, jsx_runtime_1.jsx)("div", { className: "w-3 h-3 rounded-full", style: {
                            backgroundColor: mode === 'off' ? '#9ca3af' : mode === 'view' ? secondaryColor : primaryColor,
                        } }), (0, jsx_runtime_1.jsx)("span", { className: "text-sm font-medium", children: "\u9875\u9762\u6807\u6CE8" }), annotationCount > 0 && ((0, jsx_runtime_1.jsx)("span", { className: "text-xs bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full", children: annotationCount }))] }), (0, jsx_runtime_1.jsx)("div", { className: "flex gap-1 mb-3", children: modes.map((m) => {
                ...
                }) }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between text-xs", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-1 text-gray-500", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Settings, { className: "w-3 h-3" }), (0, jsx_runtime_1.jsx)("span", { children: "User:" })] }), editingUser ? ((0, jsx_runtime_1.jsxs)("div", { className: "flex gap-1", children: [(0, jsx_runtime_1.jsx)("input", { type: "text", value: tempUser, onChange: (e) => setTempUser(e.target.value), className: "text-xs px-2 py-0.5 border border-gray-200 rounded focus:outline-none focus:ring-1 focus:ring-primary w-16", onKeyDown: (e) => e.key === 'Enter' && handleUserSave(), onClick: (e) => e.stopPropagation() }), (0, jsx_runtime_1.jsx)("button", { onClick: (e) => {
                                    e.stopPropagation();
                                    handleUserSave();
                                }, className: "text-xs px-2 py-0.5 bg-primary text-white rounded hover:bg-primary/90", children: "\u786E\u5B9A" })] })) : ((0, jsx_runtime_1.jsx)("button", { onClick: (e) => {
                            e.stopPropagation();
                            setEditingUser(true);
                        }, className: "text-xs text-primary hover:text-primary/80 font-medium", children: user }))] }), (0, jsx_runtime_1.jsxs)("div", { className: "text-xs text-gray-400 mt-2 pt-2 border-t border-gray-100", children: [mode === 'edit' && (0, jsx_runtime_1.jsx)("p", { children: "\u70B9\u51FB\u9875\u9762\u4EFB\u610F\u4F4D\u7F6E\u521B\u5EFA\u6807\u6CE8" }), mode === 'view' && (0, jsx_runtime_1.jsx)("p", { children: "\u70B9\u51FB\u6807\u6CE8\u70B9\u67E5\u770B\u8BE6\u60C5\u4E0E\u8BC4\u8BBA" }), mode === 'off' && (0, jsx_runtime_1.jsx)("p", { children: "\u6807\u6CE8\u5DF2\u9690\u85CF" })] })] }));
}
