...
import { MapPin, User, ChevronLeft, ChevronRight, CalendarDays } from "lucide-react"
...
const typeStyles: Record<ScheduleEvent["type"], { bg: string; border: string; badge: string; label: string }> = {
  course: {
    bg: "bg-blue-50",
